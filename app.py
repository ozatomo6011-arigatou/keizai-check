...
これを見て、必ず次の見出しをそのまま使った形式で日本語で出力してください。
全体を通じて、投資や経済が初めての小学生高学年でもわかるくらい平易な言葉で書いてください。専門用語が必要な場合は、必ず「やさしい表現（専門用語）」の形で書いてください。例：「投資家たちが怖くなって売り始めた（リスクオフ）」「みんな積極的に買いたい気分になった（リスクオン）」。専門用語だけで書くことは避けてください。
また、国や指数によって値動きが違う場合（例：日本の株価だけが大きく上がった、など）は、「人気が高まったから」のような曖昧な理由づけだけで済ませないでください。その業種の会社は他の国にもあるはずなので、「なぜ他の国ではなく、その国・指数に特に強く影響したのか」を具体的に説明してください（例：その指数は特定の業種の比率が高い、など）。理由として筋が通っているか、書く前に一度自分で確認してください。

【まとめ】
（今日の市場全体の動きを100字程度で。専門用語ゼロ、小学生でもわかる言葉で）

【注目ポイント】
（今日いちばん目立った動きとその理由を100字程度で。推測でOK、こちらも小学生レベルの言葉で）

【今日の市場まとめを読んで疑問に思ったこと】
（メンター面談で聞くと良さそうなポイントを1つ、1文で）

【質問への回答】
（上記の質問に対する、あなた自身の回答・考え方を150字程度で。小学生にもわかるやさしい言葉で説明してください。【注目ポイント】と同じ内容の繰り返しにならないよう、そこにはまだ書いていない別の視点（今後の見通し、注意しておきたい点など）を必ず加えてください）

【記事タイトル】
（note記事のタイトルを1行、30〜40字程度で。以下のルールに必ず従うこと。
・「経済チェック｜」から始める
・今日の市場データの中でいちばん特徴的な指標や動きをキーワードとして入れる（検索されやすくするため）
・キーワードに続けて、【今日の市場まとめを読んで疑問に思ったこと】で立てた疑問と同じ内容・同じ方向性の疑問を自然な文章で入れる（本文の内容と食い違わないようにするため。タイトルだけの新しい疑問を作らないこと）
・「買うべきか」「買っても大丈夫か」のような、売買の判断を尋ねる形は避けること。あくまで「何が起きているのか」「何を知っておくといいか」を知りたくなるような、情報提供型の疑問にすること
